...
def test_loader(dataset, batch_size, input_dict):
    ...
    if dataset == 'bird256':
        ...
        txt_path = '/Users/solomon/school/App_Aura/AuraPalette/aura-palette-backend/backend/model_api/data/hexcolor_vf/test_names.pkl'
        pal_path = '/Users/solomon/school/App_Aura/AuraPalette/aura-palette-backend/backend/model_api/data/hexcolor_vf/test_palettes_rgb.pkl'
        img_path = '/Users/solomon/school/App_Aura/AuraPalette/aura-palette-backend/backend/model_api/data/bird256/test_palette/test_images_origin.txt'
